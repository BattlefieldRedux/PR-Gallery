...
<body>
	...
	<div id="Header">
		...
		<div id="Title-Wrapper">
			<div id="Title">Project Reality</div>
			<div id="SubTitle"></div>
		</div>
		<div id="Search">
	...
	<div id="Body-Wrapper">
		 <div id="Container-Navigation">
			 <div id="Nav">
				<ul>
					<a href="http://www.realitymod.com/forum/"><li>Forum</li></a>
					<a href="http://tournament.realitymod.com/forum/"><li>Tournament</li></a>
					<a href="http://www.realitymod.com/prspy/"><li>PRSPY</li></a>
				</ul>
			 </div>
		 </div>
	...
	var options = {interval: 6.2439024390243902439024390243902,
